...
// Mock VLAN data
const mockVlans = [
  { id: 10, name: "SERVERS", state: "active", switch: "arista-leaf-01" },
  { id: 20, name: "STORAGE", state: "active", switch: "arista-leaf-01" },
  { id: 30, name: "MGMT", state: "active", switch: "arista-leaf-02" },
  { id: 100, name: "GUESTS", state: "suspended", switch: "arista-spine-01" },
];

const VLANManager = () => {
  const [vlans, setVlans] = useState(mockVlans);
